      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <th>휴대전화 / 일반전화</th>
            <td>
              <input type="text" class="phone" name="phone01" />
              <span>-</span>
              <input type="text" class="phone" name="phone02" />
              <span>-</span>
              <input type="text" class="phone" name="phone03" />
            </td>
          </tr>
          <tr class="bottom">
            ...
            <td>
              ...
              <span>@</span>
              <!-- 직접 입력시 readonly 풀기 -->
              <input type="text" class="email02" name="email01" />
              <span></span>
              <select class="domain">
