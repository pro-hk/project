        ...
        <div class="customerContents counsel">
          <div class="contentsBox">
            ...
            <p>
              ...
              원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 상법 및 ‘전자상거래등에서 소비자보호에 관한 법률’ 등 관련 법령의 규정에 의하여 다음과 같이
              거래 관련 관리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할 필요가 있을 경우에는 일정기간 보유합니다.<br />
          ...
          <div class="contentsBox">
            <p>
              ※귀하는 개인정보 수집·이용에 동의하지 않을 권리가 있으며, 동의를 거부할 경우에는 회원가입을 통한 상품 구매, 고객상담, 이벤트 참여기회 제공 등 사이트 서비스 이용에 제한될 수 있습니다.
            </p>
          </div>
