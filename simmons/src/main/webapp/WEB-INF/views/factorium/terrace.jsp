	    ...
	    <div class="root">
	        <div class="line">
	            <ul>
	                ...
	                <li class="on"><a href="Terrace">TERRACE</a></li>
	                <li><a href="Come">오시는 길</a></li>
	            </ul>
	        </div>
	    </div>
	    <div class="factorium">
	        <h3 class="title">SIMMONS Terrace</h3>
	        <div class="gal">
	            <h4 class="gTitle">시몬스의 철학과 역사, 기술력, 브랜드 가치와 품격을 담은 소셜 스페이스</h4>
	            <p class="script">
	                한국 시몬스는 완벽한 수면에 대한 연구 끝에<br />
	                ‘좋은 수면은 취향이 반영된 삶(GOOD SLEEP=GOOD LIFE)’이라는<br />
	                새로운 카테고리를 만들어 냈습니다<br />
	                취향은 개인의 라이프스타일과 수면 습관, 쉼으로부터 시작됩니다<br />
	                시몬스가 브랜드 유산과 장인 정신을 토대로 잘 잘 수 있는 환경을 만들어 왔다면<br />
	        ...
	        <div class="gal">
	            <p class="script">
	                시몬스 대표 매트리스 컬렉션인 뷰티레스트 컬렉션 부터 다양한 디자인의 프레임,<br />
	        ...
	        <div class="gal">
	            <p class="script">
	                시몬스의 독보적 매트리스 설계 노하우를 그대로 느낄 수 있는 체험존으로<br />
	        ...
	        <div class="gal">
	            <p class="script">
	                국내 최고의 브랜드 뮤지엄, 헤리티지 앨리에서는<br />
	                1870년부터 이어온 시몬스의 역사이자 인류 침대의 역사를 한 눈에 살펴보실 수 있습니다<br />
	        ...
	        <div class="gal">
	            <p class="script">
	                1960~70년대는 미국 문화 중에서도 레트로 컬처가 가장 풍성했던 시기로<br />
	                호텔은 당시의 무드를 아이코닉한 컬처 코드를 반영해 만든 공간입니다<br />
